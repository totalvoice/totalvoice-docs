### Glossário
 ...
 abaixo uma lista com suas definições:  
  ...
  - **DID:** O DID (Direct Inward Dialing), é um número virtual que em vez de ser atribuído a um local específico, eles podem ser comprados com a Zenvia e atribuídos a um número já existente. Estes números 
